...
public final class HorizontalPager extends ViewGroup {
    ...
    private void init() {
        ...
        _dragdropManager = ((DroidBoardApplication)getContext()).GetDragDropManager();
    }
...
//                    
        ...
        // Toast.makeText(getContext(), "intercept touch", Toast.LENGTH_SHORT).show();
        return intercept;
    }
    ...
    public boolean onTouchEvent(final MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                Toast.makeText(getContext(), "page down", Toast.LENGTH_SHORT).show();
                break;
            case MotionEvent.ACTION_MOVE:
                final int xDiff = (int) Math.abs(x - mLastMotionX);
                boolean xMoved = xDiff > mTouchSlop;
            ...
            case MotionEvent.ACTION_UP:
                ...
                mTouchState = TOUCH_STATE_REST;
                Toast.makeText(getContext(), "page up", Toast.LENGTH_SHORT).show();
                break;
            case MotionEvent.ACTION_CANCEL:
                mTouchState = TOUCH_STATE_REST;
                Toast.makeText(getContext(), "page cancel", Toast.LENGTH_SHORT).show();
                break;
            default:
                break;
        }
